...
(custom-set-variables
 ...
 '(org-agenda-files (quote ("~/Personal/bookmarks.org" "~/Projekte/web-utils/readme.org" "~/Personal/spiele.org" "~/Personal/sns.org" "~/Personal/notizen.org" "~/Personal/privat.org" "~/Perfezionamento/thesis/phd-thesis.en.org")))
 '(safe-local-variable-values (quote ((ispell-dictionary . "it") (Syntax . ANSI-Common-Lisp) (Syntax . COMMON-LISP) (Base . 10) (Syntax . Common-Lisp) (ispell-dictionary . "de") (ispell-dictionary . "en_GB") (ispell-dictionary . "english") (whitespace-line-column . 80) (lexical-binding . t) (org-babel-python-command . "sage -python")))))
(custom-set-faces

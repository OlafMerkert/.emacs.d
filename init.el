...
(custom-set-variables
 ...
 '(safe-local-variable-values (quote ((Syntax . ANSI-Common-Lisp) (Syntax . COMMON-LISP) (Base . 10) (Syntax . Common-Lisp) (ispell-dictionary . "de") (ispell-dictionary . "en_GB") (ispell-dictionary . "english") (whitespace-line-column . 80) (lexical-binding . t) (org-babel-python-command . "sage -python")))))
(custom-set-faces
